        ...
        <CardContent className="flex flex-col gap-4">
          ...
          {conversionRate && (
            <Typography variant="h6" className="mt-2">
              1 {baseCurrency} = {formatNumber(conversionRate.toFixed(4))} {targetCurrency}
            </Typography>
          )}

          {convertedAmount && (
            <Typography variant="h6">
              {formatNumber(amount)} {baseCurrency} = {formatNumber(convertedAmount.toFixed(2))} {targetCurrency}
            </Typography>
          )}
        </CardContent>
      </Card>
